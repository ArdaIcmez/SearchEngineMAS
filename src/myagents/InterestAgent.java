...
import myagents.HistoryAgent.HandleProfileOperation;
...
public class InterestAgent extends Agent implements RankingVocabulary{
	private static final long serialVersionUID = 1L;
	private Object obj = null;
	private RankingHandle roleExecution = new RankingHandle("InterestDocument");
	private Codec codec = new SLCodec();
	private Ontology ontology = RankingOntology.getInstance();
	private float constQuery = (float) 0.1;
	private float constInterest = (float) 0.8;
